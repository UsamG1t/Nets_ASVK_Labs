...
## Быстрый поиск по лабораторной:
 + [Протокол RIP](./Маршрутизация%20сетей%20с%20использованием%20RIP.md#Протокол%20RIP)
 + [Пример настройки RIP](./Маршрутизация%20сетей%20с%20использованием%20RIP.md#Пример%20настройки%20RIP)
	 + [Базовая настройка виртуальных машин](./Маршрутизация%20сетей%20с%20использованием%20RIP.md#Базовая%20настройка%20виртуальных%20машин)
	 + [BIRD Routing Daemon](./Маршрутизация%20сетей%20с%20использованием%20RIP.md#BIRD%20Routing%20Daemon)
	 + [Настройка RIP](./Маршрутизация%20сетей%20с%20использованием%20RIP.md#Настройка%20RIP)
 + [Самостоятельная работа](./Маршрутизация%20сетей%20с%20использованием%20RIP.md#Самостоятельная%20работа)
