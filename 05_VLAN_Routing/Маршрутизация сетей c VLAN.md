# Лабораторная работа №5 — Маршрутизация сетей c VLAN
...
## Быстрый поиск по лабораторной:
 ...
 + [Построение сети с VLAN](./Маршрутизация%20сетей%20c%20VLAN.md#Построение-сети-с-VLAN)
	 + [Настройка абонентов](./Маршрутизация%20сетей%20c%20VLAN.md#Настройка-абонентов)
	 + [Настройка пограничного маршрутизатора](./Маршрутизация%20сетей%20c%20VLAN.md#Настройка-пограничного-маршрутизатора)
	 + [Настройка коммутатора](./Маршрутизация%20сетей%20c%20VLAN.md#Настройка-коммутатора)
	 + [Настройка статических маршрутов](./Маршрутизация%20сетей%20c%20VLAN.md#Настройка-статических-маршрутов)
	 + [Проверка настройки сети](./Маршрутизация%20сетей%20c%20VLAN.md#Проверка-настройки-сети)
