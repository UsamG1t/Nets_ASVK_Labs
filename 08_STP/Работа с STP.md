...
Полученные отчёты `report.08.r1`, `report.08.r2`, `report.08.r3`, `report.08.r4`, `report.08.r5` через последовательный порт перенести из виртуальной машины отчёты и прислать их преподавателю с подписью выполненного варианта.
