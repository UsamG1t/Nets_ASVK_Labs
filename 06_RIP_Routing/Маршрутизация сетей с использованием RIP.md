...
Полученные отчёты `report.06.pc1`, `report.06.pc2`, `report.06.r1`, `report.06.r2`, `report.06.r3` через последовательный порт перенести из виртуальной машины отчёты и прислать их преподавателю с подписью выполненного варианта.
